...
const styles = StyleSheet.create({
  ...
  gridLabel: { fontSize: 12.5, color: '#737373', fontWeight: '500', marginBottom: 1 },
  gridLabelRight: { fontSize: 12.5, color: '#737373', fontWeight: '500', marginBottom: 1, textAlign: 'right' },
  gridValue: { fontSize: 13.5, fontWeight: '700', color: '#1c1917' },
  gridValueRight: { fontSize: 13.5, fontWeight: '700', color: '#1c1917', textAlign: 'right' },
  ...
  tearCutoutLeft: { left: -28 },
  tearCutoutRight: { right: -28 },
